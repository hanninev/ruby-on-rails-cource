...
describe "BeermappingApi" do
  ...
  it "When HTTP GET returns five entry, they are parsed and returned" do
    ...
    lplace = places.last
    expect(lplace.name).to eq("Simapaja")
    expect(lplace.street).to eq("Kipparinkuja 2")
  end

  it "When HTTP GET don't returns entry, it returns an empty array" do
